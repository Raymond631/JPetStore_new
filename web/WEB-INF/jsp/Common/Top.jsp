...
<div class="header">
    <div class="logo">
        <%--        <div class="logoImg">--%>
        <%--            <a href="../Pet/homePage"><img style="background-size: cover;height: 100%" src="../images/logo-topbar.gif"/></a>--%>
        <%--        </div>--%>
        <div class="logoName">
    ...
    <div class="top-right">
        ...
        <a href="../Cart/cartList">
            <img align="middle" name="img_cart" src="../images/shopping.png"/></a>
        <%--        <img align="middle" src="../images/separator.gif"/>--%>
        <c:if test="${sessionScope.user == null}">
            <a href="../User/showLogin">
                <img align="middle" name="img_cart" src="../images/login.png"/></a>
            <%--            <img align="middle" src="../images/separator.gif"/>--%>
        ...
        <li class="navbar-item flexbox-left">
            <a class="navbar-item-inner flexbox-left" href="../Pet/petList?category=fish">
                <div class="navbar-item-inner-icon-wrapper flexbox">
                    ...
                    <%--                       href="../Pet/petList?category=fish">--%>
