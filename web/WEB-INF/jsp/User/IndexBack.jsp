	...
	<div class="bottomRight">
		...
		<div class="tip">
			<div class="advice">Prepare more
				<span style="color:red" id="most">${requestScope.json.get("min_stock_pet")}</span></div>
			<div class="cause" style="background-color: rgb(26,179,148);">${requestScope.json.get("min_stock")}</div>
		</div>
		<div class="tip" style="border:white">
			<div class="advice">Prepare less
				<span style="color:red">${requestScope.json.get("max_stock_pet")}</span>
			</div>
			<div class="cause" style="background-color: rgb(237,85,101);">${requestScope.json.get("max_stock")}</div>
		</div>
	</div>
</div>
</body>
